...
This will open a browser window where you log in with your Anthropic account — the same email and password you use for [claude.ai](https://claude.ai). Once you approve the connection in the browser, Claude Code is ready to use in the terminal. If you accidentally chose the API key option, run `claude logout` and then `claude` again to pick OAuth.
