...
> I'm getting `ModuleNotFoundError: No module named 'pandas'` when I run my script, but I thought I installed it. The environment is `my-project` and here's what `conda list` shows:
>
> [paste output]
>
> What's wrong?

*Include the environment name and the output of `conda list`. Claude can spot if the package is missing or if you're in the wrong environment.*
:::
