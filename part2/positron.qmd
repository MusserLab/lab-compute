...
In [Your First R Project](../part1/first-project.qmd), you used Positron's core features—the console, environment pane, data viewer, plots pane, and terminal—to run a single-cell analysis. This chapter covers those features in more depth, plus keyboard shortcuts, customization, and workflows you'll use daily.
...
Claude will check your conda installation path, Positron's Python discovery settings, and suggest fixes—typically a settings.json edit or a Positron reload.
:::
