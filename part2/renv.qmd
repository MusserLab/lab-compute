...
>
> `* Project 'my-project' is out-of-sync -- use renv::status() for details`
>
> I ran `renv::status()` and it shows:
>
> [paste the output]
>
> What should I do—restore or snapshot?

*Include the actual `renv::status()` output. It tells Claude exactly what's out of sync.*
:::
...
The default renv setup handles this correctly. If you used the `.gitignore` from the [first project chapter](../part1/first-project.qmd), these exclusions are already in place.
