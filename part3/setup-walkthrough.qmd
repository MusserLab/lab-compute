...
If you haven't already set up the GitHub CLI (`gh`), follow the installation and authentication steps in the [Git & GitHub chapter](../part2/git-github.qmd#sec-github-auth). Once authenticated, you can create repositories and push code from the terminal.
