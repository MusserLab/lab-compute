...
>
> This is the code that caused it: [paste relevant code or filename:line]. What's happening?

*Include both the error AND the code. Claude can trace the issue much faster with context.*
:::
...
Try: "In analysis.R line 45, I get 'object x not found'. Here's the relevant code: [paste code]. The data is loaded from data/raw/data.csv."
